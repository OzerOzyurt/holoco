...
export class SliderowlComponent {
  ...
  carouselData: WritableSignal<CarouselData[]> = signal([
    { id: 'slide-1', baslik:'Mirela Türk Kahvesi', text: '%100 Arabica Çekirdeklerinden Özenle Hazırlanmış Türk Kahvesi', img: "assets/slider/mirela1000.webp",subtext: 'Mirela ', price:'1000g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Türk kahvesi geleneğinin eşsiz lezzetini, dünyanın en kaliteli kahve çekirdeklerinden olan %100 Arabica ile bir araya getirdik. Yüksek kaliteli Arabica çekirdeklerinin karakteristik yumuşak ve zengin tat profili sayesinde, her fincanda eşsiz bir içim deneyimi sunuyoruz.', status: false },
    { id: 'slide-2',baslik:'Private Filtre Kahve', text: 'Sumatra, Brezilya (Alfenas) ve Cherr Çekirdekleri ile Özel Filtre Kahve Deneyimi', img: "assets/slider/private1kg.jpg",subtext: 'Private ', price:'1000g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Dünyanın en özel kahve bölgelerinden getirilen çekirdeklerle hazırlanan bu filtre kahve, kahve tutkunlarına zengin aroma ve dengeli bir lezzet sunuyor. Sumatra’nın egzotik topraklarından gelen çekirdeklerin derinliği, Brezilya Alfenas bölgesinin yumuşak karakteri ve Cherr çekirdeklerinin tatlı notaları ile harmanlanmış bu kahve, her fincanda benzersiz bir deneyim yaşatır.', status: false  },
    { id: 'slide-3',baslik:'Puplic Çekirdek Kahve', text: 'Endonezya ve Brezilya’dan Sertifikalı %70 Arabica & %30 Robusta Kahve Harmanı', img: "assets/slider/public1kg.jpg",subtext: 'Public ', price:'1000g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Bu özel kahve, Endonezya ve Brezilya’dan özenle seçilen, sertifikalı %70 Arabica ve %30 Robusta çekirdeklerinden üretilmiştir. Yoğun bir aroma ve dengeli lezzet arayan kahve severler için özel olarak hazırlanmış bu harman, her yudumda eşsiz bir kahve deneyimi sunar.', status: false  },
    ...
    { id: 'slide-6',baslik:'Mirela Türk Kahvesi', text: '%100 Arabica Çekirdeklerinden Özenle Hazırlanmış Türk Kahvesi', img: "assets/slider/mirela500.webp",subtext: 'Mirela', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Türk kahvesi geleneğinin eşsiz lezzetini, dünyanın en kaliteli kahve çekirdeklerinden olan %100 Arabica ile bir araya getirdik. Yüksek kaliteli Arabica çekirdeklerinin karakteristik yumuşak ve zengin tat profili sayesinde, her fincanda eşsiz bir içim deneyimi sunuyoruz.', status: false  },
    { id: 'slide-7',baslik:'Private Filtre Kahve', text: 'Sumatra, Brezilya (Alfenas) ve Cherr Çekirdekleri ile Özel Filtre Kahve Deneyimi', img: "assets/slider/private500gr.jpg",subtext: 'Private', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Dünyanın en özel kahve bölgelerinden getirilen çekirdeklerle hazırlanan bu filtre kahve, kahve tutkunlarına zengin aroma ve dengeli bir lezzet sunuyor. Sumatra’nın egzotik topraklarından gelen çekirdeklerin derinliği, Brezilya Alfenas bölgesinin yumuşak karakteri ve Cherr çekirdeklerinin tatlı notaları ile harmanlanmış bu kahve, her fincanda benzersiz bir deneyim yaşatır.', status: false  },
    { id: 'slide-8',baslik:'Puplic Çekirdek Kahve', text: 'Endonezya ve Brezilya’dan Sertifikalı %70 Arabica & %30 Robusta Kahve Harmanı', img: "assets/slider/public500gr.jpg",subtext: 'Public', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Bu özel kahve, Endonezya ve Brezilya’dan özenle seçilen, sertifikalı %70 Arabica ve %30 Robusta çekirdeklerinden üretilmiştir. Yoğun bir aroma ve dengeli lezzet arayan kahve severler için özel olarak hazırlanmış bu harman, her yudumda eşsiz bir kahve deneyimi sunar.', status: false  },
    ...
    { id: 'slide-11', baslik:'Mirela Türk Kahvesi', text: '%100 Arabica Çekirdeklerinden Özenle Hazırlanmış Türk Kahvesi', img: "assets/slider/mirela250.webp",subtext: 'Mirela ', price:'250g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'Türk kahvesi geleneğinin eşsiz lezzetini, dünyanın en kaliteli kahve çekirdeklerinden olan %100 Arabica ile bir araya getirdik. Yüksek kaliteli Arabica çekirdeklerinin karakteristik yumuşak ve zengin tat profili sayesinde, her fincanda eşsiz bir içim deneyimi sunuyoruz.', status: false },
