...
export class SliderowlComponent {
  ...
  carouselData: WritableSignal<CarouselData[]> = signal([
    { id: 'slide-1', baslik:'Baslık', text: 'Açıklama', img: "assets/slider/mirella1kg.jpg",subtext: 'Mirela ', price:'1000g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'metin', status: false },
    ...
    { id: 'slide-6',baslik:'Baslık', text: 'Açıklama', img: "assets/slider/mirella500gr.jpg",subtext: 'Mirela', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'metin', status: false  },
    ...
    { id: 'slide-9',baslik:'Baslık', text: 'Açıklama', img: "assets/slider/tangle500gr.jpg",subtext: 'Tangle', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'metin', status: false  },
    { id: 'slide-10',baslik:'Baslık', text: 'Açıklama', img: "assets/slider/terra500gr.jpg",subtext: 'Terra', price:'500g', dataMerge: 2, width: 210, dotContent: 'text1',   description: 'metin', status: false  },
